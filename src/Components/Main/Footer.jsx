...
const Footer = () => {
  return (
    <div className=" w-full flex flex-col mobile:flex-row items-center justify-evenly bg-blue-300 text-[14px] p-[20px] gap-[30px]">
      ...
      <div className=" flex-center flex-col ">
        ...
        <p>ارتباط با حراست: herasat@ iaun.ac.ir</p>
